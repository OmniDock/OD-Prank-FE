...
import PubScenarioCard, { PubScenarioCardProps } from "./PubScenarioCard";
...
useEffect(() => {
    var scenarios_responses: Scenario[]
    fetchPublicScenarios().then((data: Scenario[]) => scenarios_responses = data);
